<template>
  ...
  <DataTable
    ...
    v-model:expandedRows="purgedObjects.details"
    dataKey="key"
    :value="purgedObjects"
...
import {purgedObject, purgedObjects} from "../types/purged-object";
import {
  Button,
  Column,
  DataTable,
...
const onPage = (event: DataTablePageEvent) => {
  ...
  if (undefined !== purgedObjectsTable.value.d_sortField) {
    formData.append('sortField', purgedObjectsTable.value.d_sortField as string);
...
const onSort = (event: DataTableSortEvent) => {
  ...
  purgedObjectsTable.value.d_first = paginationPage.value * purgedObjectsTable.value.d_rows;
